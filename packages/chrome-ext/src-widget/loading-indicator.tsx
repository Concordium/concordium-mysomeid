...
const FailedIcon = ({width, height}: {width: string, height: string}) => {
	return (
	<svg version="1.0" xmlns="http://www.w3.org/2000/svg"
	 width={width} height={height} viewBox="0 0 1280.000000 1138.000000"
...
export function LoadingIndicator({sx, failedLoading, text}: any) {
	return (
    <Box id="loading-indicator" sx={{
    	display: 'flex',
    	...
    	{
    		failedLoading === true ?
    			<FailedIcon width="50px" height="50px" /> :
